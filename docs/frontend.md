...
paragraph to explain._

<!-- Agent: after the PRD is agreed, describe here (short!):
     - the layout (what sits where, matching the sketch)
     - colors and type (list the actual values used)
     - interaction patterns (what happens on click/drag/type) -->
